...
export async function GET() {
    ...
    const prompt = [
        `Pretend you are a helpful chatbot for a ${settings.scenario} company. You will not be dealing with real information or real customers.`,
        `You must speak with a formality level (out of 10, where 10 is very formal and 0 uses lots of slang): ${settings.slang}`,
